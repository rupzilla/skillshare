...
class UpvotesControllerTest < ActionController::TestCase
  ...
  test "should create upvote" do
    assert_difference('Upvote.count') do
      post :create, upvote: { active: @upvote.active, user_id: @upvote.user_id, workshop_id: @upvote.workshop_id }
    end
  ...
  test "should update upvote" do
    put :update, id: @upvote, upvote: { active: @upvote.active, user_id: @upvote.user_id, workshop_id: @upvote.workshop_id }
    assert_redirected_to upvote_path(assigns(:upvote))
  end
